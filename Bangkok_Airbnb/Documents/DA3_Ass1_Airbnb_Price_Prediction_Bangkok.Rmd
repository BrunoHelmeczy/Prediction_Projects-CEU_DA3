...
```{r price distr,  message = F,warning = F, cache= TRUE ,echo = FALSE,results = "asis",fig.align='center' , fig.height = 2.5, fig.width = 6}
...
```{r models ,  message = F,warning = F, echo = FALSE, fig.align='center', fig.height = 3, fig.width = 6, cache = TRUE}
...
```{r Final Model Summary, cache= T,  message = F,warning = F, echo = FALSE, fig.align='center', fig.height=2.5, fig.width=3.5, cache=T}
...
SumStatsFinalModelTable <- 
  as.data.frame(cbind(Rsq,rbindlist(lapply(data_holdout_w_prediction[c("predicted_price")], function(x) {
  tl <- list()
...
rownames(SumStatsFinalModelTable) <- "Final Random Forest Model"
#colnames(SumStatsFinalModelTable) <- NULL

SumStatsFinalModelTable %>% as_hux()  
```
...
```{r,  message = F,warning = F, echo = FALSE,results = "asis", fig.height=2.5,fig.width=6, cache=T}
...
```{r,  message = F,warning = F, echo = FALSE,fig.align= 'center', fig.height=2.5,fig.width = 6, cache=T}
...
```{r,  message = F,warning = F, echo = FALSE, fig.align= 'center', fig.height=2.5,fig.width=3.5, cache=T}
...
```{r Var Imp Plots,message = F,warning = F, echo = FALSE,fig.align= 'center', fig.height=2.5,fig.width=3.5, cache = T}
#########################################################################################
